...
export default function OrderPage() {
  ...
  return (
    <div className="w-full pt-20 px-4 sm:px-6 md:px-8">
      <div className="max-w-7xl mix-blend-saturation"></div>
      <h3 className="text-2xl font-semibold mb-4 text-orange-500 pb-5">
        All Orders
      </h3>
